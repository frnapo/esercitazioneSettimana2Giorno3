...
for (var i = 0; i < starWarsCharacters.length; i++) {
  ...
  var eyeColorValue = character.eye_color;
...
/* --EXTRA-- ESERCIZIO 9
  ...
  for (var i = 0; i < femaleCharacters.length; i++) {
...
/* --EXTRA-- ESERCIZIO 10
  ...
  var randomNumber = Math.floor(Math.random() * starWarsCharacters.length);
  console.log("Si chiama " + starWarsCharacters[randomNumber].name);
  console.log("E' alt* " + starWarsCharacters[randomNumber].height + " cm");
  console.log("Pesa " + starWarsCharacters[randomNumber].mass);